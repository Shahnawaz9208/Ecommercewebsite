...
<head>
     <meta name="viewport" content="width=device-width, initial-scale=1">
        ...
        <title>Contact | New Style Store</title>
        <style type="text/css">
            .p1{
                text-align: justify;
            }
